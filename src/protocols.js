...
export const ELEMENTS = [
  ...
  { id: 'frankenstein', name: 'FRANKENSTEIN', kind: 'enemy', tier: 3, minDoor: 17, unlockAt: 0, weight: 0, impl: true, byBoss: true,
    blurb: 'Composite unit. Two sidearms. The plate is the rest of him.',
    meet: 'Two guns. Only his arms shatter.', hint: 'Shoot off each arm.' },
  { id: 'drone', name: 'DRONE', kind: 'enemy', tier: 4, minDoor: 24, unlockAt: 0, weight: 0, impl: true, byBoss: true,
    blurb: 'Observation unit. It does not shoot. It does not need to.',
    meet: 'While it flies, the others aim better.' },
  { id: 'spawner', name: 'SPAWNER', kind: 'enemy', tier: 4, minDoor: 31, unlockAt: 0, weight: 0, impl: true, byBoss: true,
    blurb: 'Personnel restoration. Signal-dependent.',
    meet: 'Brings shattered enemies back.', hint: 'Break the dish while they are down.' },
