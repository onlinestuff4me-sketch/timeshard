...
| `duelschool.mjs` | NO RETREAT's opening lesson, played rather than described: the player arrives with no weapon, the first round stops the world with DODGE THIS and a ring on the round, stepping aside brings the pistol AND the second half — TAP HERE TO SHOOT, a ring on a man and a thumb pressing on his chest, no second thumb on the card — and firing puts both away. Then the rules that keep it from nagging: the room that already said it does not say it again, a NEW room standing in a round's lane earns hearing it a second time, a third round never does, and two more rooms of shattering nothing do not produce a third telling. |
