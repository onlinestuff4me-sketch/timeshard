...
| `newsbadge.mjs` | Both entry points carry the news, the archive says what is new at the top and marks the rows it means, PLAY THE NEW MODES lands on the mode board, and every badge clears once the page has been seen — including across a reload. |
